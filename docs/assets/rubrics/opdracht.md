...
* Op basis van de SBOM en de CVE's met bijbehorende CVSS-scores heb je een onderbouwd en bruikbaar advies opgesteld over updates naar nieuwere versies van de libraries waar het systeem van afhankelijk is.
