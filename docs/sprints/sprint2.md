...
| 2.3 | **Bow-tie analyse**: voor het risico met de hoogste score: top event, minimaal 3 preventieve barrières en 2 herstelbarrières, gekoppeld aan NEN-7510:2026 controls                                                               | `docs/auditrapport/05-bowtie.md` + diagram               | ❌ Open |     |
