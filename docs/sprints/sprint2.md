...
| 2.4 | **SAST & SCA scan uitvoeren**: OWASP Dependency-Check (SCA), Semgrep (SAST) en CycloneDX (SBOM) op de idgen-module; sla ruwe output op                                                                                    | `Groep_6_Security-Analyse.md` + dependency-check-report.html, bom.xml, bom.json, sast-report.json               | ✅ Compliant | SimonEulenpesch |
| 2.5 | **Security backlog samenstellen**: minimaal 5 bevindingen; kolommen: Finding ID, CVE/CWE, CVSS-score, Contextuele score, NEN-7510 control, Prioriteit (H/M/L), Status, False positive-rationale (indien van toepassing)          | `docs/LU2 - Kwaliteit en security - verbeteronderzoek security/Groep_6_Security-Analyse.md`               | ✅ Compliant | SimonEulenpesch |
| 2.6 | **Patchadvies schrijven**: op basis van de SBOM en CVE/CVSS-scores: welke libraries updaten, in welke volgorde, verwachte risicoreductie | `docs/LU2 - Kwaliteit en security - verbeteronderzoek security/Groep_6_Patchadvies.md` | ✅ Compliant | Rowen Albers |
...
- [X] SAST- en SBOM-scan loopt automatisch in CI en output is opgeslagen
- [X] Security backlog heeft minimaal 5 bevindingen met CVSS + NEN-7510 koppeling
- [X] Patchadvies is onderbouwd met CVE-data uit de SBOM
