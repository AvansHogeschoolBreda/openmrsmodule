...
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- |
| 5.1 | **Module-keuze vastleggen**: documenteer de gekozen module (naam, versie, link naar broncode) en motiveer de keuze (complexiteit, scope, kritieke functionaliteit)                                                                      | `README.md` of `docs/module-keuze.md`                                                           | ✅ Compliant             | Bestand aangemaakt (`Groep_6_Module-Keuze.md`) maar nog niet ingevuld                                                                                                              |                 |
