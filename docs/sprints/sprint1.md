...
| 5.2 | **Repository inrichten**: branch protection (main is protected), MFA voor alle leden, Dependabot alerts aan, CodeQL workflow actief                                                                                                     | GitHub Security-tab toont geen rode vlaggen                                                         | ⚠️ Gedeeltelijk        | Branch protection geconfigureerd (niet afdwingbaar op Free), Dependabot aan, CodeQL aan. MFA niet verifieerbaar via repo. | RafvanHooijdonk |
| 5.3 | **OTAP-omgeving opzetten**: docker-compose per omgeving (dev / test / prod), GitHub Environments met protection rules                                                                                                                   | `docker-compose.yml` + `.github/environments/`                                                  | ⚠️ Gedeeltelijk        | GitHub Environments aangemaakt (production + test). docker-compose ontbreekt nog.                                         | RafvanHooijdonk |
...
| 5.6 | **Mini-complianceverslag**: tabel: per NEN-7510 control, pipeline-maatregel, bewijs                                                                                                                                                     | `docs/LU2 - Kwaliteit en security - verbeteronderzoek security/Groep_6_Mini-Complianceverslag.md` | ❌ Open                  | Bestand aangemaakt met header en structuur. Nog in te vullen.                                                             |                 |
