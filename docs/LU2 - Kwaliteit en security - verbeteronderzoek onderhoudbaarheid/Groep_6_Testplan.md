...
De `IdentifierSourcePayloadMapper` (de verplaatste logica) staat op 91,7% line coverage met nul open issues; de afgeslankte resource op 98,8% line coverage. Daarmee zijn de NFR-doelen voor onderhoudbaarheid gehaald: nul Brain Methods, Quality Gate geslaagd, coverage en duplicatie ruim binnen norm. De volledige onderbouwing van het ontwerp staat in `Groep_6_Refactoring-Onderbouwing.md`.
