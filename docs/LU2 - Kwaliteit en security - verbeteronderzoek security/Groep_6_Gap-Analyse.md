...
**Module:**
**Versie:**
**Onderzochte controls:** A.8.3 (toegangsbeveiliging), A.8.5 (authenticatie), A.8.15 (logging)
...
| A.8.15 Logging | Logbestanden worden aangemaakt, bewaard en beschermd | <!-- aanwezig / gedeeltelijk / afwezig --> | | |

---

## Conclusie

<!-- Samenvatting van de bevindingen: wat is aanwezig, wat ontbreekt, wat zijn de grootste gaps -->
